...
server_packet_address = ('localhost', 1001)  # Entity_1 address
server_ack_address = ('localhost', 1002)  # Entity_1 address
client_packet_address = ('localhost', 1003)  # Entity_2 address
client_ack_address = ('localhost', 1004)  # Entity_2 address
